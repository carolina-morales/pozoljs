...
let fileControllerContent = fs.readFileSync('../../templates/generate/component/test.controller.ts', 'utf8');
let fileServiceContent = fs.readFileSync('../../templates/generate/component/test.service.ts', 'utf8');
let fileRoutesContent = fs.readFileSync('../../templates/generate/component/test.routes.ts', 'utf8');
let fileInterfaceContent = fs.readFileSync('../../templates/generate/component/test.interface.ts', 'utf8');
